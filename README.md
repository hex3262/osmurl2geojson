...
## Limitation
- The track that was newly generated by router.project-osrm.org may not always match the original track obtained from routing.openstreetmap.de, particularly in less evaluated regions and for less well elaborated transportation modes such as bike and hiking. Do the followign in such cases:
...
8. Set the format dropdown to **geojson** (may be recognized automatically).
9. Once again click the **Import data** icon.
10. Click **Browse** again, but now select the generated `umap_route.geojson` file.
11. Click **Import**.
